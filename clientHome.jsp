...
<html>
<head>
	<title>Client User App Servlet</title>
	<style type='text/css'>
	<!--  body{background-color:black; color:white; font-family:calibri;}
	 h1{font-size:40pt; text-align:center; color: red;} h2{font-size:35pt; text-align:center; color: turquoise;} 
...
<body>
	...
	<hr></hr>
	<p>You are connected to the Project 4 Enterprise System database as a <font color=red>client-level</font> user.<br>
	Please enter any valid SQL query or update command in the box below.</p>
	<form action="ClientUserAppServlet" method="post">
